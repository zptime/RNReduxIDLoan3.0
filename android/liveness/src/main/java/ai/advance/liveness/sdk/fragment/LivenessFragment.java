...
public class LivenessFragment extends Fragment implements Detector.DetectorInitCallback, LivenessCallback {
            ...
            if (activity != null) {
                new AlertDialog.Builder(activity).setMessage(errorMessage).setPositiveButton(R.string.liveness_perform, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        toResultActivity(resultEntity, null);
                        dialog.dismiss();
                    }
                }).create().show();
            }
    ...
    /**
     * to the default result page,please override it when necessary
     */
    public void toResultActivity(ResultEntity entity, Bitmap bitmap) {
    ...
    public void onDetectionSuccess() {
        mLivenessView.getLivenessData(new LivenessGetFaceDataCallback() {
            ...
            public void onGetFaceDataSuccess(ResultEntity entity, String livenessId) {
                // TODO Be sure to check anti-spoofing with your server here,The value of livenessScore in the entity object callback here needs to be retrieved from your server, otherwise it is 0
                ...
                toResultActivity(entity, bitmap);
            }
